 ...
 * Viewport Width: 1280
 * Inserter: true
 * Description: Four key metrics in a full-width navy band with large serif gold numbers and labels.
 */
?>
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="border-right-color:rgba(255,255,255,0.1);border-right-style:solid;border-right-width:1px;padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--8);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--8)">
				...
				<!-- Label -->
				<!-- wp:paragraph {"fontSize":"xs","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.1em","fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"text":"rgba(249,248,246,0.6)"}}} -->
				<p class="has-xs-font-size" style="margin-top:0;margin-bottom:0;text-transform:uppercase;letter-spacing:0.1em;font-weight:500;color:rgba(249,248,246,0.6)"><?php echo esc_html( $stat['label'] ); ?></p>
				<!-- /wp:paragraph -->
